...
export class ConfigService {
  ...
  get typeOrmConfig(): TypeOrmModuleOptions {
    ...
    return {
      ...
      type: 'postgres',
      host: this.get('NOTIFICATIONS_POSTGRES_HOST'),
      port: this.getNumber('NOTIFICATIONS_POSTGRES_PORT'),
      username: this.get('NOTIFICATIONS_POSTGRES_USERNAME'),
      password: this.get('NOTIFICATIONS_POSTGRES_PASSWORD'),
      database: this.get('NOTIFICATIONS_POSTGRES_DATABASE'),
      migrationsRun: true,
