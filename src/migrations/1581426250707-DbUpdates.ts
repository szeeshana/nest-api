...
export class DbUpdates1581426250707 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "activity" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "is_deleted" boolean, "updated_by" character varying(100), "created_by" character varying(100), "ip" text, "user_agent" text, "parameter" text, "entity_object_id" character varying(300) NOT NULL, "action_type_id" integer, "user_id" integer, "entity_type_id" integer, CONSTRAINT "PK_24625a1d6b1b089c8ae206fe467" PRIMARY KEY ("id"))`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "activity" ADD CONSTRAINT "FK_e2e3d249df5c4bc4ef153affd64" FOREIGN KEY ("action_type_id") REFERENCES "action_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "activity" ADD CONSTRAINT "FK_4faddefa3bc5f04b6c4c327d573" FOREIGN KEY ("entity_type_id") REFERENCES "entity_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "activity" DROP CONSTRAINT "FK_4faddefa3bc5f04b6c4c327d573"`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "activity" DROP CONSTRAINT "FK_e2e3d249df5c4bc4ef153affd64"`,
      undefined,
    );
    await queryRunner.query(
